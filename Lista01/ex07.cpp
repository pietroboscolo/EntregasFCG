...
int setupGeometry();
int createSpiral(int turns, int& nPoints);
...
//#endif
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Ex07", nullptr, nullptr);
	...
	int nPoints;
	GLuint VAO = createSpiral(3, nPoints);
